# Delivery Readme
这是一个高校辅导员备考辅助 Skill为解决知识点琐碎没有体系的问题，里面包含政策学习、可用题库训练、案例分析、结构化面试、公文写作和答案批改等内容几乎涵盖所有知识点以及考点。拿到后建议先看 README.md 和 quick-start.md，直接复制里面的指令开始用。提醒一下：题库包含题目14,953，部分题目需要核对；具体考试还是要以目标高校招聘公告和官方政策为准。
题库来源包括培训资料、模拟题、真题回忆。
